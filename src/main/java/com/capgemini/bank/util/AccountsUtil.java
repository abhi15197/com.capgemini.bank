...
public class AccountsUtil {
	...
	{	SimpleDateFormat format=new SimpleDateFormat("dd-mm-yyyy");//->date format to get the required date from the string
		try {
			accounts.put("300080705001", new Account("300080705001","Kuldeep","Yadav",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705002", new Account("300080705002","Shikhar","Dhawan",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705003", new Account("300080705003","M.S","Dhoni",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705004", new Account("300080705004","Virat","Kohli",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705005", new Account("300080705005","Rohit","Sharma",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705006", new Account("300080705006","KL","Rahul",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705007", new Account("300080705007","Manoj","Tiwari",25000.00,format.parse("15-02-2017")));
			accounts.put("300080705008", new Account("300080705008","Jaspreet","Bumrah",25000.00,format.parse("15-02-2017")));
